  ...
  <div class="flex">
    <div
      class="w-20 flex-none flex flex-col min-h-screen h-screen overflow-y-auto bg-gray-900 px-2 py-2"
    >
      <div class="overflow-y-auto">
        <ul class="text-center">
          ...
          <li class="border-b border-gray-700 mx-4 mt-3 mb-5"></li>
          <li class="my-2">
            <a href="#"
              ><img
          ...
          <li class="mt-3">
            <a
              href="#"
              class="w-12 h-12 bg-gray-800 text-white inline-block rounded-full hover:bg-gray-500"
            >
              <i class="el-icon-download flex"></i>
            </a>
          </li>
          <li class="mt-3">
            <a
    ...
    <div class="flex flex-1 flex-col min-h-screen h-screen">
      <div class="text-white bg-gray-800 flex h-12">
        <div
        ...
        <div
          class="bg-gray-750 flex-1 flex items-center justify-between px-4 border-b border-gray-900"
        >
      ...
      <div class="flex-1 flex overflow-y-hidden">
        <div class="bg-gray-800 w-56 flex-none flex flex-col justify-between">
          <div class="text-sm overflow-y-auto">
            ...
            <ul class="px-2 py-3">
              <li
                class="px-2 hover:text-gray-200 hover:bg-gray-900 bg-gray-750 rounded text-gray-200"
              >
                <a href="#" class="flex items-center">
                  <span class="text-xl">#</span>
          ...
          <div class="bg-gray-850 px-2 py-2 flex items-center justify-between">
            <div class="flex items-center">
              ...
              <div class="text-xs ml-2">
                ...
                <div class="text-gray-500 text-xs">#1234</div>
              </div>
            </div>
        ...
        <div class="flex-1 flex justify-between">
          <div class="bg-gray-750 flex-1 flex flex-col justify-between">
              ...
              <div class="flex mx-6 my-3 py-4 border-t border-gray-700">
                ...
                <div class="ml-5">
                  <div>
                    ...
                    ><span class="text-xs text-gray-400 ml-1">23/04/2021</span>
                  </div>
            ...
            <div
              class="bg-gray-750 h-24 flex items-center mx-3 border-t border-gray-600"
            >
              <button
              ...
              <div class="flex-1">
                <input
                  type="text"
                  class="w-full text-sm h-10 px-2 py-2 bg-gray-700 text-gray-200 focus:outline-none rounded"
                  placeholder="Message #general"
                />
              </div>
              <div
                class="px-2 py-2 bg-gray-700 rounder-r flex items-center h-10"
              >
                <button
          ...
          <div class="bg-gray-700 w-56 flex-none overflow-y-auto p-4">
            <div class="flex flex-col mb-4">
              <div>
                <a href="#" class="text-gray-400 text-xs uppercase">CORE TEAM-1</a>
              </div>
              <div class="flex mt-3">
                <div>
                  <img
                ...
                <div class="text-white text-sm hover:text-gray-600 py-1 px-2">adamwathan</div>
              </div>
            </div>
            <div class="flex flex-col mb-4">
              <div>
                <a href="#" class="text-gray-400 text-xs uppercase">ONLINE-241</a>
              </div>
              <div class="flex my-2">
                <div>
                  <img
